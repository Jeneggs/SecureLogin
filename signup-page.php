            ...
            <div class="registration-form">
                <form action="signup.php" method="POST">
                    ...
                    <div class="email-field input-group mb-3">
                        ...
                        <input type="text" class="email-field form-control" id="email" name="email"
                            placeholder="Email" aria-label="username" aria-describedby="basic-addon1"
                            maxlength="65" minlength="6" required>
                    </div>
                    ...
                    <div class="confirm-password-field input-group mb-3">
                        ...
                        <input type="password" class="confirm-password-field form-control" id="confirm-password"
                            ...
                            aria-describedby="basic-addon1" maxlength="8" minlength="8" required>
                    </div>
                    ...
                    <div class="submit-button">
                        <button type="submit" id="mySubmitBtn" disabled="disabled" class="btn btn-danger">Register</button>
                    </div>
